          ...
          <a class="dropdown-item" href="http://localhost:8080/ticket/index.jsp">Voir les tickets</a>
                <%
      			if (currentUser.getRoles().equals("ROLE_ADMIN")){
      				out.print("<a class='dropdown-item' href='http://localhost:8080/ticket/ajout.jsp'>Créer un ticket</a>");
      			}
                %>
        </div>
      </li>
...
for (Ticket unTicket : lesTickets) {
	if (currentUser.getRoles().equals("ROLE_ADMIN")){
	    out.print ("<tr>" +
	            ...
	            "<td><center>" + new java.text.SimpleDateFormat("dd/MM/yyyy").format(unTicket.getDateCreation())+"</center></td>" +
	            "<td><center>" + new java.text.SimpleDateFormat("dd/MM/yyyy").format(unTicket.getDateExpiration())+"</center></td>" +
		...
		if (unTicket.getUser_id() == currentUser.getId()) {
		    out.print ("<tr>" +
		    		"<td>" + unTicket.getId()+"</td>" +
		            "<td>" + unTicket.getTitre()+"</td>" +
		            "<td>" +unTicket.getDescription() +"</td>" +
...
<%
if (currentUser.getRoles().equals("ROLE_ADMIN")){
	out.print("<div class='text-align-left'><a href='http://localhost:8080/ticket/ajout.jsp' type='button' class='btn btn-lg btn-primary'>Créer un ticket</a></div>");
}
%>
<br>
</div>
